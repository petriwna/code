...
import { AuthenticationService } from '@af/server/dist/authentication/authentication.service';
...
export default function SignUp() {
  ...
  //   'register',
  //   // @ts-ignore
  //   () => AuthenticationService.register(data.email, data.name, data.password),
  //   {
  //     onError: err => {
  //       console.error(err)
  //     },
